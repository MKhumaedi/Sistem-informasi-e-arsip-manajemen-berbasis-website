...
<head>
    ...
    <title>SIEMAN<?php if (isset($title)) {
    echo " - " . $title;
}
?></title>
    ...
    <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
        <div class="container">
            ...
            <div class="navbar-header">
                ...
                <a style="padding-top: 5px;" class="navbar-brand" href="<?php echo site_url('/home'); ?>"><img src="<?php echo base_url('/public/images/logo-min.png'); ?>" alt="SIEMAN" height="47"></a>
            </div>
            ...
            <div class="collapse navbar-collapse" id="arteri-main-menu">
                <ul class="nav navbar-nav">
                    ...
                    if (isset($_SESSION['akses_modul']['entridata']) && $_SESSION['akses_modul']['entridata'] == 'on') {
                        echo '<li><a href="' . site_url('/admin/entr') . '"><i class="glyphicon glyphicon-plus"></i> Arsip Baru</a></li>';
                    }
