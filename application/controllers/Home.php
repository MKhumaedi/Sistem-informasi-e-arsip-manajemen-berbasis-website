<?php
/**
 * This application is licensed under GNU General Public License version 1
 * Developers:
 * M. Khumaedi ( edikhumaedi233@gmail.com )
 *
 */
...
class Home extends CI_Controller {
  ...
  public function dl()
  {
	...
	$no=1;
  	...
  	$filename='Data Arsip SIEMAN-'.getdate()[0].'.xls'; //save our workbook as this file name
	...
	public function gologin()
	{
		...
		// $q = "sel ect * from master_user where username='$username' and password='$password'";
